...
<details style="margin-top:0.35rem; margin-bottom:0.75rem;">
  <summary style="display:inline-block; cursor:pointer; font-size:0.85rem; font-weight:600; color:#1f4e79; background:#eef5ff; border:1px solid #c7dbf7; border-radius:999px; padding:0.15rem 0.5rem; list-style:none;">
    [Abstract]
  </summary>
